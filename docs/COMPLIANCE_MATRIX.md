...
| PP-R020 | Plan: Tests | Unit, repository, sync, OAuth, component, theme, Playwright, and package-audit coverage | `docs/TEST_STRATEGY.md`, tool/test configs, `src/build/packageAudit.ts` | 33 PP-001 tests, production audits, unpacked Chromium smoke | scaffolded | Scaffold gates pass; feature-specific suites remain PP-002 through PP-010 |
